...
public class PreferenceUtil {
    ...
    public static final String SHARE_PREFERENCE_NAME = "ZEGO_LIVE_QUIZ";
    ...
    public static final String APPID = "ZEGO_APP_ID";

    public static final String APP_KEY = "ZEGO_APP_KEY";

    public static final String APP_TEST_ENV = "ZEGO_APP_TEST_ENV";
    ...
    public String getAppIdKey() {
        String key;
        key = mSharedPreferences.getString(APP_KEY, "");
        return key;
    }
    ...
    public void setAppid(long appid) {
        setLongValue(APPID, appid);
    }

    public void setAppKey(String key) {
        setStringValue(APP_KEY, key);
    }

    public void setTestEnv(boolean testEnv) {
        setBooleanValue(APP_TEST_ENV, testEnv);
    }

    public Long getAppId() {

        return getLongValue(APPID, -1);
    }

    public boolean getTestEnv() {

        return getBooleanValue(APP_TEST_ENV, false);
    }


    private boolean getBooleanValue(String key, boolean b) {
